...
class Wcms18_Random_Dog_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'wcms18-random-dog', // Base ID
			'WCMS18 Random Dog', // Name
			[
				'description' => __('A Widget for displaying a random dog', 'wcms18-random-dog'),
			] // Args
		);
	}
